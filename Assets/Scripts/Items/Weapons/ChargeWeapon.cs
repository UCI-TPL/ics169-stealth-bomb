...
public class ChargeWeapon : Weapon {
    ...
    protected override void OnActivate(Vector3 start, Vector3 direction, PlayerController targetController = null) {
        ...
        rumbleOnce = false;
        if(player.controller.weaponParticles.Root != null)
        {
            player.controller.weaponParticles.Stop();
            player.controller.weaponParticles.Play();
        }
    }
