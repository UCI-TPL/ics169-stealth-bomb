...
[Title("Procedural", "Noise", "3D Gradient Simplex Noise")]
public class SimplexNoiseGrad3D : CodeFunctionNode
{
    public SimplexNoiseGrad3D() {
        name = "3D Gradient Simplex Noise";
    }
	...
	static string MyCustomFunction(
        [Slot(0, Binding.None)] Vector3 XYZ,
        [Slot(1, Binding.None)] Vector1 Scale,
        [Slot(2, Binding.None)] out Vector1 Out) {
        return
            @"
{
    Out = saturate((snoise_grad(XYZ * Scale) + 4) / 7);
} 
";
    }
